For the front-end part visit- https://github.com/vickky122/stream-front-end
...
Video Walkthrough
Project Demo(video) click to view
...
About
StreamZone is a comprehensive video streaming application developed with Spring Boot, MySQL, and ReactJS, designed to offer an efficient, seamless video experience. The platform allows users to easily upload, download, and stream videos, all while optimizing bandwidth and enhancing streaming performance.
